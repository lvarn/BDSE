...
#'
#' @return A named list of parameter vectors and scalars generated by the Gibbs
#'   sampler: 
#'   \itemize{ 
...
#'
#' @export
run_Gibbs_sampler_2levela <- function(
                               seed,
                               n_sims,
                               obs_distribution,
                               formula1,
  ...
  ## Design matrices and cell counts
